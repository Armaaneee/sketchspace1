SketchSpace
SketchSpace is a browser-based whiteboard with drawing, shapes, text, layers, pages, selection tools, and export. Everything runs locally and is stored in your browser, so your canvases stay on your device.
